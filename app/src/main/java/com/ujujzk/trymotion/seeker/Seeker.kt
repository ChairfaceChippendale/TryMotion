...
class Seeker: View {
    ...
    @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : super(context, attrs, defStyleAttr) {
        ...
        val a = context.theme.obtainStyledAttributes(attrs, R.styleable.Seeker, 0, 0)
        try {
    ...
    private fun extractMaxThumbDrawable(a: TypedArray, defaultValue: Drawable): Drawable {
        return a.getDrawable(R.styleable.Seeker_rsb_maxThumbDrawable) ?: defaultValue
    }

    private fun extractMinThumbDrawable(a: TypedArray, defaultValue: Drawable): Drawable {
        return a.getDrawable(R.styleable.Seeker_rsb_minThumbDrawable) ?: defaultValue
    }

    private fun extractTrackSelectedColor(a: TypedArray, defaultValue: Int): Int {
        return a.getColor(R.styleable.Seeker_rsb_trackSelectedColor, defaultValue)
    }

    private fun extractTrackColor(a: TypedArray, defaultValue: Int): Int {
        return a.getColor(R.styleable.Seeker_rsb_trackColor, defaultValue)
    }

    private fun extractTrackSelectedThickness(a: TypedArray, defaultValue: Int): Int {
        return a.getDimensionPixelSize(R.styleable.Seeker_rsb_trackSelectedThickness, defaultValue)
    }

    private fun extractTrackThickness(a: TypedArray, defaultValue: Int): Int {
        return a.getDimensionPixelSize(R.styleable.Seeker_rsb_trackThickness, defaultValue)
    }

    private fun extractTouchRadius(a: TypedArray, defaultValue: Int): Int {
        return a.getDimensionPixelSize(R.styleable.Seeker_rsb_touchRadius, defaultValue)
    }

    private fun extractSidePadding(a: TypedArray, defaultValue: Int): Int {
        return a.getDimensionPixelSize(R.styleable.Seeker_rsb_sidePadding, defaultValue)
    }

    private fun extractTrackRoundedCaps(a: TypedArray): Boolean {
        return a.getBoolean(R.styleable.Seeker_rsb_trackRoundedCaps, false)
    }

    private fun extractTrackSelectedRoundedCaps(a: TypedArray): Boolean {
        return a.getBoolean(R.styleable.Seeker_rsb_trackSelectedRoundedCaps, false)
    }

    private fun extractMinRange(a: TypedArray): Int {
        return a.getInteger(R.styleable.Seeker_rsb_minRange, 1)
    }

    private fun extractMaxValue(a: TypedArray): Int {
        return a.getInteger(R.styleable.Seeker_rsb_max, 100)
    }

    private fun extractInitialMinThumbValue(a: TypedArray): Int {
        return a.getInteger(R.styleable.Seeker_rsb_initialMinThumbValue, -1)
    }

    private fun extractInitialMaxThumbValue(a: TypedArray): Int {
        return a.getInteger(R.styleable.Seeker_rsb_initialMaxThumbValue, -1)
    }

    private fun extractMinThumbOffset(a: TypedArray): Point {
        val x = a.getDimensionPixelSize(R.styleable.Seeker_rsb_minThumbOffsetHorizontal, 0)
        val y = a.getDimensionPixelSize(R.styleable.Seeker_rsb_minThumbOffsetVertical, 0)
        return Point(x, y)
    }

    private fun extractMaxThumbOffset(a: TypedArray): Point {
        val x = a.getDimensionPixelSize(R.styleable.Seeker_rsb_maxThumbOffsetHorizontal, 0)
        val y = a.getDimensionPixelSize(R.styleable.Seeker_rsb_maxThumbOffsetVertical, 0)
        return Point(x, y)
    }
    // endregion
    // endregion
    ...
    /**
     * This interface is used to set callbacks for actions in [Seeker]
     */
